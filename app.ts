...
let person_name: string = "arsalan raza azmi";
...
let friend_list: string[] = ["Arsalan", "Saad", "Fahad", "Inam"];
...
let favouriteTransportation: string[] = [
  "Car",
  "Bike",
  "Bicycle",
  "Helicoptor",
...
let guest_list: string[] = ["Babar", "Shaheen", "Rizwan"];
...
while (guest_list.length > 2) {
  let removedList: string | undefined = guest_list.pop();
...
let numOfGuest: Number = guest_list.length;
...
let rivers: string[] = ["Jhelum", "Satlaj", "Ravi", "Indus", "Chenab"];
...
function fruitInfo(fruit: Fruit) {
...
let usernames: string[] = ["Salman", "Aslam", "Zarnish", "Admin", "Zehra"];
...
let current_users: string[] = ["Arsalan", "Sami", "Saima", "Talha", "SIDRAH"];
let new_users: string[] = ["Raza", "Sami", "Laiba", "Aslam", "Sidrah"];
...
let favorite_pizza: string[] = ["Greek pizza", "Neapolitan pizza", "Detroit pizza"];
...
let animals: string[] = ["Dog", "Cat", "Rabitt"];
...
function make_shirts(size: string = "Large", text: string = "I love TypeScript"): void {
  console.log(`The size of the shirt is ${size} and the text printed on Tshirt is "${text}"`);
}
...
function make_album(artist_name: string, album_title: string, tracks?: number): Album {
  let album: Album = { artist_name, album_title };
...
let magicians: string[] = ["Taimoor", "Ashraf", "Khuram", "Kamran"];

type StringArray = string[];

function show_magicians(magicianNames: StringArray): void {
...
function make_great(magicianNames: StringArray) {
...
let OriginalMagiciansCopy: string[] = ["Taimoor", "Ashraf", "Khuram", "Kamran"];

function make_great_copy(magicianNames: StringArray) {
  return magicianNames.map((magician: string) => `${magician} the Great`);
}

let greatMagicians: StringArray = make_great_copy(OriginalMagiciansCopy); //modified list copy
...
function make_sandwich(...items: StringArray) {
...
const carInfo = (manufacturer: string, model: number, ...additionalDetails: object[]): carDetailsType => {
  let carDetails: carDetailsType = {
